            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">Editar Abonado</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="text" name="codigo_abonado_personalizado" value="{{ $abonado->codigo_abonado }}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <input type="email" style="text-transform:uppercase;" name="email" value="{{ $abonado->email }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group bmd-form-group">
