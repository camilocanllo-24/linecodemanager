                    ...
                    <div class="card-body">
                        <form action="{{ route('payments.store') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group bmd-form-group">
                                        <label class="bmd-label-static">Tipo de pago</label>
                                        <select class="form-control selectpicker" data-style="btn btn-link" data-title="Elija un tipo de pago" name="tipo_pago" id="tipo_pago" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group bmd-form-group">
                                        <label class="label-control">Descripción del pago</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <input type="text" name="fecha_pago" class="form-control datetimepicker" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group bmd-form-group">
