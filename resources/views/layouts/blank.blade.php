...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/master_a-p_g_-maestra.css?crc=4001286305"/>
    <link rel="stylesheet" type="text/css" href="css/index.css?crc=437413599" id="pagesheet"/>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('img/apple-icon.png') }}">
    <link rel="icon" type="image/png" href="{{ asset('img/favicon.png') }}">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <title>
        @yield('titulo-pagina') | Line Code Manager
    </title>
